...
# ======================= STOCK DATA =======================
VN_STOCKS = {
    "FPT": {"name": "FPT Corporation", "sector": "Công nghệ"},
    ...
    "HCM": {"name": "HCMC Securities", "sector": "Chứng khoán"},
    "REE": {"name": "REE Corporation", "sector": "Điện"},
    ...
    "DXG": {"name": "Đất Xanh", "sector": "Bất động sản"},
    "KDH": {"name": "Khang Điền", "sector": "Bất động sản"},
    "KBC": {"name": "Kinh Bắc", "sector": "KCN"},
    "GVR": {"name": "Cao su Việt Nam", "sector": "Cao su"},
    "BVH": {"name": "Bảo Việt", "sector": "Bảo hiểm"},
    "POW": {"name": "PV Power", "sector": "Điện"},
    "GMD": {"name": "Gemadept", "sector": "Logistics"},
    "DCM": {"name": "Đạm Cà Mau", "sector": "Phân bón"},
    "DPM": {"name": "Đạm Phú Mỹ", "sector": "Phân bón"},
    "PVD": {"name": "PV Drilling", "sector": "Dầu khí"},
    "VCI": {"name": "Vietcap", "sector": "Chứng khoán"},
    "HSG": {"name": "Hoa Sen", "sector": "Thép"},
    "DGC": {"name": "Đức Giang", "sector": "Hóa chất"},
    "GEX": {"name": "Gelex", "sector": "Điện"},
    "PC1": {"name": "PC1", "sector": "Xây dựng"},
    ...
    "ANV": {"name": "Nam Việt", "sector": "Thủy sản"},
}
